        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td class="text-dark">
                    ...
                    <input type="text" name="name" value="{{ $list->name }}" class="form-control"></td>
                <td class="text-dark">
                    @if(Auth::user()->user_type == 0)
             
                <td><a class="bg-danger rounded-1" href="{{ url('/SuperAdmin/Department/Deleted/'.$list->id) }}"> <i class="fas fa-user-times" style="color: #ffffff;"></i></a></td>
                @elseif(Auth::user()->user_type == 1)
                <td>
                <button type="submit" class="btn btn-primary" >Update</button>
                <td><a class="bg-danger rounded-1" href="{{ url('/Admin/Department/Deleted/'.$list->id) }}"> <i class="fas fa-user-times" style="color: #ffffff;"></i></a></td>
                @endif
                </td>
            </tr>
            </form>
